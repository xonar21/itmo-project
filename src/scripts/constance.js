const publications = [
  {
    image: './images/publications/publication_Topic-driven Ensemble for Online Advertising Generation.png',
  ...
  {
    image: "./images/publications/publication_Convolutional neural networks with hierarchical context transfe….png",
  ...
  {
    image: './images/publications/publication_Spatiotemporal Filtering Pipeline for Efficient Social Networks Dat….png',
  ...
  {
    image: './images/publications/publication_Hybrid evolutionary workflow scheduling algorithm for dynami.png',
  ...
  {
    image: './images/publications/publication_Detection of housing and utility problems in districts through soc.png',
    title: 'Detection of housing and utility problems in districts through soc…',
  ...
  {
    image: './images/publications/publication_Decoupling graph convolutional networks for large-scale supervis….png',
  ...
  {
    image: './images/publications/publication_Peregreen–modular database for efficient storage of historical tim….png',
  ...
  {
    image: './images/publications/publication_Intelligent sightseeing in immensely manifold cities.png',
  ...
  {
    image: './images/publications/publication_User Profiles Matching for Different Social Networks Based.png',
  ...
  {
    image: './images/publications/publication_Orienteering Problem with Functional Profits for multi-sourc.png',
  ...
  {
    image: './images/publications/publication_Urban events prediction via convolutional neural networks a….png',
